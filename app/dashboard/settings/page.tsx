...
import { User, Mail, Bell, Shield, Palette, Save, CheckCircle, AlertCircle, Settings as SettingsIcon } from 'lucide-react'
import { supabase } from '@/lib/supabase'
import { useLayout } from '@/components/layout-context'

export default function SettingsPage() {
  const { preferences, updatePreferences, toggleCompactMode } = useLayout()
  ...
  const handleProfileSave = async () => {
    ...
    try {
      ...
      // authError here is non-fatal — profile row was already updated
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      ...
      if (!currentUser?.email) throw new Error('Unable to verify identity')
