...
export const dashboardStatsService = {
  async getDashboardStats(userId: string, projects: Project[]): Promise<{
    ...
    try {
      ...
      return {
        stats: [
          { title: 'Total Revenue', value: '$0', change: 'Current total', trend: 'up' },
          { title: 'Active Projects', value: '0', change: 'Current total', trend: 'up' },
          { title: 'Total Rewards', value: '0', change: 'Current total', trend: 'up' },
          { title: 'Total Reconciliations', value: '0', change: 'Current total', trend: 'up' }
        ],
        monthlyRevenueData: [],
        userGrowthData: [],
        revenueByProduct: []
